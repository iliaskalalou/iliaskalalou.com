  ...
  return (
    <section className="relative flex min-h-svh flex-col justify-center px-6 md:px-12">
      <motion.div variants={container} initial="hidden" animate="show">
        ...
        <motion.h1
          variants={item}
          className="text-[13vw] leading-[0.95] font-semibold tracking-tight md:text-[8.5vw]"
        >
          Ilias Kalalou
        </motion.h1>
        ...
        <motion.h2
          variants={item}
          className="mt-2 text-[8vw] leading-[0.95] font-semibold tracking-tight text-muted md:text-[5vw]"
        >
          AI &amp; Data Engineer
        </motion.h2>
      ...
      <motion.p
        ...
        className="absolute bottom-8 left-6 text-xs uppercase tracking-[0.25em] text-muted md:left-12"
      >
        Scroll
      </motion.p>
    </section>
